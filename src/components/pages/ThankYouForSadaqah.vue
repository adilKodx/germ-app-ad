<template>
    <scroll-container>
      <full-page-slide class="-first" :btns="false">
        <div>
          <h1 style="color :#C11718" class="header-2 italic header mb-6">
            {{ getLabel("Bedankt voor jouw vrijgevige bijdrage!") }}
          </h1>
  
          <p class="sub-text mb-8">
            {{
              getLabel("Moge Allah jou zegenen en belonen. Ameen. Jouw liefdevolle en vrijgevige hart zijn de bouwstenen van onze gemeenschap en we zijn zo dankbaar voor jouw bijdrage. Zo kunnen we de organisatie verder versterken. Samen werken we aan een betere wereld en tonen we aan dat we er voor elkaar zijn. Jij bent echt een held!")
            }}
          </p>
          <p class="sub-text mb-8">
            {{
              getLabel("Dankzij jouw gift kunnen we moslims in Nederland ondersteunen die het zwaar hebben en hen voorzien van duurzame oplossingen. Jouw hulp maakt het verschil en geeft hen weer hoop.")
            }}
          </p>
          <p class="sub-text mb-8 bold">
            {{
              getLabel("Je bent nu een officiële NZF-ambassadeur en behoort tot onze NZF-familie. We zijn benieuwd naar wie jij bent en wat jou inspireert om anderen te helpen. Vertel ons hieronder meer over jezelf en hoe je nog meer wilt bijdragen aan onze gemeenschap.")
            }}
          </p>
