    ...
    <full-page-slide class="-first" :btns="false">
      <div>
        <h1 style="color :#C11718" class="header-2 italic header mb-6">
          {{ getLabel("Hartelijk dank voor jouw Zakat en gulle bijdrage!") }}
        </h1>

        <p class="sub-text mb-8">
          {{
            getLabel("Moge Allah(swt) jou zegenen en belonen. Jouw vrijgevigheid en liefde zijn de krachten die onze gemeenschap in stand houden. Samen werken we aan een betere wereld en laten we zien dat we om elkaar geven. Jij bent een ware held!")
          }}
        </p>
        <p class="sub-text mb-8">
          {{
            getLabel("Met jouw giften kunnen we moslims in Nederland ondersteunen die het moeilijk hebben en hen voorzien van duurzame oplossingen. Door jouw steun kunnen we hun levens veranderen en hen weer hoop geven.")
          }}
        </p>
        <p class="sub-text mb-8 bold">
          {{
            getLabel("Je bent nu officieel een NZF-ambassadeur en maakt deel uit van de NZF-familie. We willen graag meer over jou weten! Vertel ons hieronder meer over jezelf en op welke andere manier je zou willen helpen")
          }}
        </p>
